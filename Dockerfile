...
RUN wget https://downloads.tuxfamily.org/godotengine/3.4/mono/Godot_v3.4-stable_mono_linux_headless_64.zip
RUN mkdir _godot
RUN mv Godot_v3.4-stable_mono_linux_headless_64.zip _godot/godot.zip
RUN unzip _godot/godot.zip
RUN rm -rf _godot
RUN mv Godot_v3.4-stable_mono_linux_headless_64/ _godot
RUN ln _godot/Godot_v3.4-stable_mono_linux_headless.64 _godot/godot
