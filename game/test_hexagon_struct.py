...
color1, color2, color3, color4, color5, color6 = pygame.Color(1, 1, 1), pygame.Color(2, 2, 2), pygame.Color(
    3, 3, 3), pygame.Color(4, 4, 4), pygame.Color(5, 5, 5), pygame.Color(6, 6, 6)
hexagon = hexagon_struct.HexagonStruct((300, 300), pygame.Color(255, 255, 255),
